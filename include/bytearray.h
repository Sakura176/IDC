#ifndef __SERVER_BYTEARRAY_H__
#define __SERVER_BYTEARRAY_H__
...
namespace server
{
	...
	public:
		 ...
		 * 		 如果 m_position > m_size 则 m_size = m_position
		 */
		void writeFuint16(int16_t value);
		 ...
		 * 		 如果 m_position > m_size 则 m_size = m_position
		 */
		void writeFuint32(int32_t value);
