#ifndef __server_HTTP_HTTP_H__
#define __server_HTTP_HTTP_H__
...
namespace server { namespace http 
{
	...
	/**
	 * @brief 获取Map中的的key值,并转成对应类型，返回是否成功
	 * @param m Map数据结构
	 * @param key 关键字
	 * @param val 保存转换后的值
	 * @param def 默认值
	...
	public:
		...
		typedef std::map<std::string, std::string, CaseInsensitivaLess> MapType;
