...
int main(int argc, char const *argv[])
{
	...
	if (argc != 4)
	{
		...
		printf("        /project/tools/bin/gzipfiles /project/tmp/surfdata \"*.xml,*.json\" 0.01\n");
		printf("        /project/tools/bin/procctl 300 /project/tools/bin/gzipfiles /log/idc \"*.log.20*\" 0.02\n");
		printf("        /project/tools/bin/procctl 300 /project/tools/bin/gzipfiles /tmp/tmp/surfdata \"*.xml,*.json\" 0.01\n\n");
